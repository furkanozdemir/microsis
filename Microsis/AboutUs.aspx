<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="Microsis.AboutUs" %>
        ...
        <div class="page-content">
            <div class="container">
                <div class="two-thirds column">
                    <h3 style="margin: -10px 0 15px 0;">Biz Kimiz ?</h3>
                ...
                <div class="one-third column">
                    <h3 style="margin: -10px 0 15px 0;">Kariyer</h3>

                    <!-- Large Notice -->
                    <div class="large-notice">
                        <h2>Bizimle çalışmak ister misiniz ?</h2>
                        <p></p>
                        <a href="#" class="button medium color">Başvur</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="eight columns">
                    <!-- Headline -->
                    <br />
                    <h3 class="margin-reset">Ne Yapıyoruz ?</h3>
                    <br />
            ...
            <div class="sixteen columns">
                    <h3>Takımımızla Tanışın</h3>
                    <br />
                </div>
                <div class="one-third column">
                    <img src="images/about-03.jpg" alt="" />
                    <div class="team-name">
                        <h5>Mustafa Türkeş</h5>
                        <span>Chief Executive Officer / CEO</span></div>
                    <div class="team-about">
                        <p>Consectetur dolor ipsum quiam dolor adipisci velit, aenean at lorem vel est posuere feugiat sed quia noneas numquasa mode tempora incidunt.</p>
                    </div>
                </div>
                <div class="one-third column">
                    <div class="clear"></div>
